...
- Web: `pnpm typecheck`, `pnpm lint:strict`, `pnpm test`, `pnpm build`, `pnpm check:bundles`, `pnpm test:e2e` (in `apps/web`, or `make web-lint`; E2E needs `pnpm build` first — see `docs/architecture/testing.md`)
